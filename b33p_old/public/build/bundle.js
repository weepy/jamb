...
var app = (function () {
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*projects*/ 1 && t_value !== (t_value = /*project*/ ctx[3].id + "")) set_data_dev(t, t_value);
    		},
    ...
    function create_fragment(ctx) {
    	...
    	let t1;
    	let h2;
    	let t2_value = /*projects*/ ctx[0].length + "";
    	let t2;
    	let t3;
    	let t4;
    	let t5;
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file, 23, 0, 284);
    			add_location(h2, file, 25, 0, 301);
    			add_location(button, file, 30, 0, 398);
    		},
    		...
    		m: function mount(target, anchor, remount) {
    			...
    			if (remount) dispose();
    			dispose = listen_dev(button, "click", /*createProject*/ ctx[1], false, false, false);
    		},
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*projects*/ 1 && t2_value !== (t2_value = /*projects*/ ctx[0].length + "")) set_data_dev(t2, t2_value);
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	onMount(() => {
    		networker("project:list", p => {
    			$$invalidate(0, projects = p);
    		});
    	});

    	function createProject() {
    		networker("project:create", p => {
    			
    		}); // projects = p
    	}

    	const writable_props = ["networker"];
    	...
    	$$self.$set = $$props => {
    		if ("networker" in $$props) $$invalidate(2, networker = $$props.networker);
    	};
    	...
    	return [projects, createProject, networker];
    }

    class Home extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance, create_fragment, safe_not_equal, { networker: 2 });
    		...
    		if (/*networker*/ ctx[2] === undefined && !("networker" in props)) {
    			console.warn("<Home> was created without expected prop 'networker'");
    		}
    	}
    ...
    /* src/pages/Project.svelte generated by Svelte v3.20.1 */
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$1, 6, 0, 40);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class Project extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$1, create_fragment$1, safe_not_equal, { socket: 0 });
    		...
    		if (/*socket*/ ctx[0] === undefined && !("socket" in props)) {
    			console.warn("<Project> was created without expected prop 'socket'");
    		}
    	}
    ...
    */
    ...
    /* src/App3.svelte generated by Svelte v3.20.1 */
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	const { users, timelines, instruments } = project;
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<App3> was created with unknown prop '${key}'`);
    	});
    	...
    	return [page$1, params, networker];
    }
